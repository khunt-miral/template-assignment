...
$(document).ready(function () {
    ...
    (function (t, e) {
        ...
        return (
            ...
            (e.prototype.start = function (e) {
                function i(t) {
                    o.album.push({ link: t.attr("href"), title: t.attr("data-title") || t.attr("title") });
                }
                var o = this,
                    n = t(window);
                n.on("resize", t.proxy(this.sizeOverlay, this)), t("select, object, embed").css({ visibility: "hidden" }), this.sizeOverlay(), (this.album = []);
                var s,
                    a = 0,
                ...
                if (r) {
                    ...
                    for (var h = 0; h < s.length; h = ++h) i(t(s[h])), s[h] === e[0] && (a = h);
                }
                var d = n.scrollTop() + this.options.positionFromTop,
                    c = n.scrollLeft();
                this.$lightbox.css({ top: d + "px", left: c + "px" }).fadeIn(this.options.fadeDuration), this.options.disableScrolling && t("body").addClass("lb-disable-scrolling"), this.changeImage(a);
            }),
                ...
                (n.onload = function () {
                    ...
                    o.attr("src", i.album[e].link),
                        ...
                        i.options.fitImagesInViewport &&
                            ...
                            (n.width > h || n.height > l) &&
                                (n.width / h > n.height / l ? ((r = h), (a = parseInt(n.height / (n.width / r), 10)), o.width(r), o.height(a)) : ((a = l), (r = parseInt(n.width / (n.height / a), 10)), o.width(r), o.height(a)))),
            ...
            (e.prototype.sizeContainer = function (t, e) {
                ...
                n !== a || s !== r
                    ? this.$outerContainer.animate({ width: a, height: r }, this.options.resizeDuration, "swing", function () {
                          i();
                      })
                    : i();
            }),
            ...
            (e.prototype.keyboardAction = function (t) {
                ...
                27 === e || i.match(/x|o|c/)
                    ...
                    : ("n" === i || 39 === e) && (this.currentImageIndex !== this.album.length - 1 ? this.changeImage(this.currentImageIndex + 1) : this.options.wrapAround && this.album.length > 1 && this.changeImage(0));
            }),
    ...
    (jQuery.event.special.touchstart = {
        setup: function (t, e, i) {
            this.addEventListener("touchstart", i, { passive: !e.includes("noPreventDefault") });
        },
    }),
    (jQuery.event.special.touchmove = {
        setup: function (t, e, i) {
            this.addEventListener("touchmove", i, { passive: !e.includes("noPreventDefault") });
        },
    }),
